 ...
 * Sourced from https://bulldogztowing.com.
 */
...
export const BUSINESS = {
  ...
  // Google Maps embed of the Glen Rock, PA area centered on the listed location.
  mapsEmbedSrc: 'https://www.google.com/maps?q=Bulldogz+Towing+Glen+Rock+PA&output=embed',
} as const
