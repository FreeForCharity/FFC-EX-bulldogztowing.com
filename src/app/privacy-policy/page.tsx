      ...
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="prose prose-neutral mt-8 max-w-none text-neutral-800">
          ...
          <p>
            ...
            the cookie banner. Everywhere else, including the United States, analytics cookies are
            set from your first pageview. You can change your choice at any time via the Cookie
