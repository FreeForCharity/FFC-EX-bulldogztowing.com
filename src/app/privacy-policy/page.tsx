      ...
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="prose prose-neutral mt-8 max-w-none text-neutral-800">
          ...
          <p>
            ...
            it; Swiss visitors&apos; data is protected by the Swiss FADP rather than the GDPR.)
            ...
            footer of every page; withdrawing consent deletes the tracking cookies this site set.
            Session recording (Microsoft Clarity) and marketing (Meta Pixel) load only after you
            explicitly opt in — everywhere in the world.
          </p>
          <p>
